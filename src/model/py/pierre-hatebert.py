...
# %%
CUSTOME_NAME = "pierre-hatebert"

# Dataset
DATA_DIR_PATH = os.path.abspath("../../data")
IMPORTED_MODEL_PATH = os.path.join(DATA_DIR_PATH, "hatebert-offenseval")
...
def load_bert_model(nb_labels):
    ...
    BERT for finetuning
    '''
    logger.info(f"transformers.BertTokenizer : hatebert offenseval file path")                                                                                                                                              
    logger.info(f"transformers.AutoModel : hatebert offenseval file path")
    tokenizer = transformers.BertTokenizer.from_pretrained(IMPORTED_MODEL_PATH)
    tr_model = transformers.AutoModel.from_pretrained(IMPORTED_MODEL_PATH)
