...
# %%
CUSTOME_NAME = "pierre-xlnet-pwbce"
...
def load_bert_model(nb_labels):
    ...
    BERT for finetuning
    '''
    logger.info(f"transformers.AutoTokenizer : xlnet-base-cased")
    logger.info(f"transformers.AutoModel : xlnet-base-cased")
    tokenizer = transformers.AutoTokenizer.from_pretrained('xlnet-base-cased')
    tr_model = transformers.AutoModel.from_pretrained('xlnet-base-cased')
