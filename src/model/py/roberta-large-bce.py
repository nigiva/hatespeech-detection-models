...
# %%
CUSTOME_NAME = "roberta-large-bce"
...
def load_roberta_model(nb_labels):
    ...
    '''
    logger.info(f"transformers.RobertaTokenizer : roberta-large")
    logger.info(f"transformers.AutoModel : roberta-large")
    tokenizer = transformers.RobertaTokenizer.from_pretrained('roberta-large')
    tr_model = transformers.AutoModel.from_pretrained('roberta-large')
