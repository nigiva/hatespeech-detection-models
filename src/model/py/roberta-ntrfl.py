...
nb_samples_pos, nb_samples_neg = get_nb_samples_lab(train_df)
criterion = ResampleLoss(reweight_func=None, loss_weight=1.0,
                            focal=dict(focal=True, alpha=0.5, gamma=2),
                            logit_reg=dict(init_bias=0.05, neg_scale=2.0),
                            class_freq=nb_samples_pos, train_num=len(train_df))
